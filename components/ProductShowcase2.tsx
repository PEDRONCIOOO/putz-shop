...
import { ProductShowcase2 as ProductShowcaseImage } from "@/public";
...
const productVariations = [
  ...
  { color: "Burgundy", hex: "#592D2A", image: ProductShowcaseImage },
  { color: "Sky Blue", hex: "#7CE8E2", image: ProductShowcaseImage },
  { color: "Black", hex: "#000000", image: ProductShowcaseImage },
  { color: "Cream", hex: "#EFE5C3", image: ProductShowcaseImage },
  { color: "Silver", hex: "#D8D9DA", image: ProductShowcaseImage },
];

export default function ProductShowcase2() {
  const [selectedColor, setSelectedColor] = useState(productVariations[0]);

  return (
    <div className="w-full max-w-5xl mx-auto border-2 border-black dark:border-white grid grid-cols-1 md:grid-cols-2 rounded-2xl mt-8">
      {/* Right Side - Product Image */}
      <div className="flex items-center justify-center border-r-2 border-black dark:border-white bg-transparent">
        <Image
